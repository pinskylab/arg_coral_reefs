...
wosgenetics <- fread('data/web_of_science/WoS_2022-10-18_population_genetics_coral.txt', quote = "") # "population genetics" & "coral" in Topic
wosgenomics <- fread('data/web_of_science/WoS_2022-10-18_population_genomics_coral.txt', quote = "") # population genomics & coral in Topic
for(i in 1:25){
    if(i ==1) wosall <- fread('data/web_of_science/WoS_2022-10-18_population_genomics_1.txt', quote = "") # "population genomics" in Topic, tranch 1
    if(i>1){
